...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=int,
        default=3,
        help='total cells of the generator'
    )
    parser.add_argument(
        '--max_epoch',
        type=int,
    ...
    parser.add_argument(
        '--load_path',
        default= './logs/autogan_search_2021_02_01_19_19_25',
        #default='./my_logs/autogan_search_2021_02_01_09_58_09',
        type=str,
        help='The reload model path')
    parser.add_argument(
        '--exp_name',
        type=str,
        default='autogan_search')
    parser.add_argument(
        '--d_spectral_norm',
        type=str2bool,
        default=True,
